...
REPORT_INTERVAL=150                    # interval of status reporting (seconds)
NET_INTERVAL=1350                      # interval of networking testing 
NET_INTERVAL_SHORT=1300                # short interval of net testing (just on mobile)
NET_INTERVAL_FORCED=1200               # short interval of net testing (wifi, hopefully on planes)
