...
close_brave_tabs(){
	...
	adb -s $device_id shell am start -n $browser_package/$browser_activity -a $intent -d "brave://about"
	if [ $device_id == "LGH870eb6286bb" -o $device_id == "LGH870b714ee1b" ] 
	then 
		tap_screen 1000 2580 2
		tap_screen 1280 2580 2
		tap_screen 733 2025  5
	elif [ $device_id == "e1afce790502" ] 
	then 
		tap_screen 770 2140 2
		tap_screen 970 2140 2
		tap_screen 670 1750  5
	fi 
}
...
close_all(){
	...
	then 
		adb -s $device_id shell "input tap 550 1700"
